...
class account_financial_report(models.Model):
    ...
    sign = fields.Selection([(-1, 'Reverse balance sign'), (1, 'Preserve balance sign')], 'Sign on Reports',
                            ...
                            help='For accounts that are typically more debited than credited and that '
                                 'you would like to print as negative amounts in your reports, you should '
                                 'reverse the sign of the balance; e.g.: Expense account. The same applies '
                                 'for accounts that are typically more credited than debited and that you '
                                 'would like to print as positive amounts in your reports; e.g.: Income '
                                 'account.')
