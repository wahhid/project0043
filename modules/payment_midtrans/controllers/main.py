...
class MidtransController(http.Controller):
    ...
    @http.route('/midtrans/finish', auth='none', csrf=False, type='json')
    def midtrans_finish(self, **post):
        return 'finish'

    @http.route('/midtrans/unfinish', auth='none', csrf=False, type='json')
    def midtrans_unfinish(self, **post):
        return ''

    @http.route('/midtrans/error', auth='none', csrf=False, type='json')
